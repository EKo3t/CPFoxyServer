...
using TemplateAuth.Providers;
using TemplateAuth.Results;
...
namespace TemplateAuth.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("Role")]
        [HostAuthentication(DefaultAuthenticationTypes.ExternalCookie)]        
        public async Task<IHttpActionResult> hasRole(Dictionary<string, string> role)
        {
            return Ok(User.IsInRole(role["role"]));
        }
